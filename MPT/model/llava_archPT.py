...
from .multimodal_encoder.builderPT import build_vision_tower
...
class LlavaMetaModel:
    ...
    def __init__(self, config, PT_len, VIT_PT_len):
        super(LlavaMetaModel, self).__init__(config, PT_len, VIT_PT_len)
        self.VIT_PT_len = VIT_PT_len
        self.PT_len = PT_len
        if hasattr(config, "mm_vision_tower"):
            self.vision_tower = build_vision_tower(config, self.VIT_PT_len, delay_load=True)
    ...
    def initialize_vision_modules(self, model_args, VIT_PT_len, fsdp=None):
        ...
        vision_tower = build_vision_tower(model_args, VIT_PT_len)
